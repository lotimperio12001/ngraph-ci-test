...
def _load_config(file_dir="./docs/website/generator", file_name="config.json"):
    try:
...
# Save static page to file
with open("./docs/website/subpages/index_dev.html", "w") as f:
    f.write(index_static)

# # Generate details pages
# for framework in database_stable:
#     index_template = env.get_template("index.html")
#     index_static = index_template.render(
#         database_dev=database_dev, database_stable=database_stable
#     )
